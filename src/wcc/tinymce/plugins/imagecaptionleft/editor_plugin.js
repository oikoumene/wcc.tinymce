...
(function() {
    ...
    tinymce.create('tinymce.plugins.ImageCaptionLeft', {
        ...
        init : function(ed, url) 
        {
            ...
            // Register commands
            ed.addCommand('mceInsertImageCaptionLeft', function() 
            {
                t._execCommand();
            });

            // Register image caption button
            ed.addButton('imagecaptionleft', 
            {
                title : 'Image caption (Left)',
                cmd : 'mceInsertImageCaptionLeft',
            ...
            */
            ...
            if (par && !t._getParentNode(par,["div"]))  
            {
                ...
                divArticleMeta = ed.dom.create('div',
	            	{
	            		'class':'imagecaption imagecaptionleft'
	            	});
        ...
        _nodeChange : function(ed, cm, n) 
        {
            ...
            if (tinyMCE.activeEditor.id != ed.id) 
              return;
            // Set button state
            cm.setDisabled('imagecaptionleft', this._getParentNode(n, ["div"]));
        },
    ...
    // Register plugin
    tinymce.PluginManager.add('imagecaptionleft', tinymce.plugins.ImageCaptionLeft);
})();
